    ...
    <div className="max-w-4xl mx-auto space-y-8 p-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div className="md:col-span-2 space-y-6 min-w-0">
          <form onSubmit={handleUpdateProfile} className="glass-card p-4 sm:p-8 space-y-6 sm:space-y-8 min-w-0">
          ...
          <div className="glass-card p-4 sm:p-8 flex flex-col sm:flex-row items-center justify-between gap-4 sm:gap-6 min-w-0">
             <div className="flex items-center gap-3 sm:gap-4 min-w-0 w-full sm:w-auto">
               <div className="w-12 h-12 sm:w-16 sm:h-16 rounded-2xl bg-emerald-500/10 flex items-center justify-center text-emerald-600 shrink-0">
                  <ShieldCheck className="w-6 h-6 sm:w-8 sm:h-8" />
               </div>
               <div className="min-w-0 flex-1 text-left">
                  <h4 className="text-base sm:text-lg font-black text-slate-900 tracking-tight truncate">{t('verified_specialist')}</h4>
                  <p className="text-[9px] sm:text-[10px] font-bold text-slate-400 uppercase tracking-widest truncate">{t('auth_id')}: {user?.user_metadata?.id_code || 'GUEST-001'}</p>
               </div>
             </div>
             <div className="flex flex-wrap gap-2 justify-center shrink-0">
                <span className="px-3 sm:px-4 py-1 sm:py-1.5 bg-emerald-100 text-emerald-600 rounded-full text-[9px] sm:text-[10px] font-black uppercase tracking-widest">{t('active')}</span>
                <span className="px-3 sm:px-4 py-1 sm:py-1.5 bg-slate-100 text-slate-600 rounded-full text-[9px] sm:text-[10px] font-black uppercase tracking-widest">V-Level 1</span>
             </div>
          </div>
        </div>
      </div>
